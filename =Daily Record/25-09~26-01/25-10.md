...
### 今日統整
- 寫了一些內容，但還不夠。突然就倒了，很想睡覺
## 10/31 (Fri.)
### To-do
- [ ] 統整內容找出還需要找尋什麼東西？
### 今日統整
##### 不同的想法
- fog types 會被包含進 visibility 中，不能算成是另一個factors
	- 可以模擬不同的 fog
- 不同的 object height
##### 霧氣模擬
- 不同的霧氣需要有不同的 extinction coefficient 和 maximum height of the fog
### 未來目標
- 接續這個往下看 [-1-](https://chatgpt.com/g/g-68b1634441388191bf055096dae85dc6-literature-guider/c/6904a891-6350-8323-88a4-a1d17b83a0f8)
	- advection fog 和 radiation fog 的差別。看能不能給予 extinction coefficient 些概念。
- 不同種類的霧氣到底該怎麼跟 extinction coefficient 有完美的結合